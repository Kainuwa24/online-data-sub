...
public class BiometricAuthPlugin extends Plugin {
    // Class 2 (face) + Class 3 (strong fingerprint) — best compatibility on real devices
    ...
    public void isAvailable(PluginCall call) {
        ...
        // Fall back: some devices only report success for one authenticator flag
    ...
    public void authenticate(PluginCall call) {
        ...
        // Keep the call alive until the prompt callback resolves/rejects.
                ...
                BiometricPrompt prompt = new BiometricPrompt(
                    ...
                    new BiometricPrompt.AuthenticationCallback() {
                        ...
                        public void onAuthenticationError(int errorCode, @NonNull CharSequence errString) {
                            if (!finished.compareAndSet(false, true)) return;
                            // User cancel should not look like a hard failure to the UI layer
                            boolean cancelled =
                            ...
                            // Resolve (not reject) so JS can handle cancel vs failure cleanly
                            call.resolve(ret);
                        }
    ...
    /** Prefer weak|strong; fall back to whichever the device reports as usable. */
